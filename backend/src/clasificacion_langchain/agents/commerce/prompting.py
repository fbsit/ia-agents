    ...
    return [
        {
            ...
            "content": (
                ...
                "Si pregunta medios de pago usa get_payment_options. "
                "get_shipping_options devuelve unicamente los METODOS de envio disponibles (ej: retiro en tienda, despacho a domicilio), nunca una lista de zonas o comunas cubiertas. "
                "Usa get_shipping_options SOLO si el usuario quiere elegir o confirmar el metodo de despacho para SU pedido actual (ej: 'como me lo despachan', 'tienen retiro en tienda', 'quiero que me lo envien'). "
                "Si en cambio pregunta que ZONAS, COMUNAS O SECTORES cubre el despacho (ej: 'en que zona entregan', 'a que comunas llegan', 'hacen despacho a tal comuna', 'llegan a mi sector'), es una pregunta de cobertura, no de metodo: NO uses get_shipping_options -no tiene esa informacion y la respuesta seria incorrecta o generica-, marca intent=none, tool=none, y ademas needs_clarification=false (sin clarification_question) para que la responda directamente el catalogo de conocimiento del negocio en vez de pedirle mas datos al cliente. "
