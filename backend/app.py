...
from clasificacion_langchain.inference_graph import build_inference_graph
...
if not model_path.exists():
    st.error("No existe models/classifier.joblib. Entrena primero con train_model.py")
    st.stop()
...
text = st.text_area(
    "Escribi un texto:",
    value="hoy me siento frustrado con el servicio",
    height=120,
)
