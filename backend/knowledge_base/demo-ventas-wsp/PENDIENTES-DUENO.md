# Pendientes para el dueno de Emporio Sura (no indexar)
...
- shampo-ballerina-manzanilla: moneda '$' normalizada a CLP
- bandeja-de-huevo: moneda '$' normalizada a CLP
- clorinda: moneda '$' normalizada a CLP
- quix-500ml: moneda '$' normalizada a CLP
- f6feea2c-8ee3-4bef-b453-b3034ac92de9: moneda '$' normalizada a CLP
